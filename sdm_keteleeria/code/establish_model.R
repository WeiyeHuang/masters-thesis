...
presence_all <- read.csv("./wc/Training/keteleeria_filtered.csv")
presence_all <- vect(presence_all, geom = c("Longitude", "Latitude"))

pseudoabsence_data <- read.csv("./wc/Training/keteleeria_absence.csv")
...
# Save the above data
write.csv(presence_train, "./wc/Training/presence_train.csv")
write.csv(presence_test, "./wc/Training/presence_test.csv")
write.csv(pseudoabsence_train, "./wc/Training/pseudoabsence_train.csv")
write.csv(pseudoabsence_test, "./wc/Training/pseudoabsence_test.csv")
...
model_list <- c("GLM", "GBM", "CTA", "MARS", "RF", "XGBOOST", "MAXNET")
...
write.csv(modeval_eval, "./wc/Evaluation/modeval_eval.csv")
modeval_varimp <- get_variables_importance(modeval_for_evaluation)
write.csv(modeval_varimp, "./wc/Evaluation/modeval_varimp.csv")

# Save the data up to now
save.image("./wc/RData/modeval.RData")
...
write.csv(tss_summary, "./wc/Evaluation/modeval_eval_tss.csv", row.names = F)
tss_summary <- read.csv("./wc/Evaluation/modeval_eval_tss.csv")
...
# Read data
modeval_varimp <- read.csv("./wc/Evaluation/modeval_varimp.csv")
tss_weights <- read.csv("./wc/Evaluation/modeval_eval_tss.csv")
...
# Output result table
write.csv(modeval_varimp_mean, "./wc/Evaluation/modeval_varimp_mean.csv", row.names = F)

# Read data
modeval_eval_tss <- read.csv("./wc/Evaluation/modeval_eval_tss.csv")
modeval_varimp_mean <- read.csv("./wc/Evaluation/modeval_varimp_mean.csv")
...
write.csv(modproj_eval, "./wc/Evaluation/modproj_eval.csv")
modproj_varimp <- get_variables_importance(model_for_projection)
write.csv(modproj_varimp, "./wc/Evaluation/modproj_varimp.csv")
save.image("./wc/RData/single_models.RData")
...
tss_summary <- aggregate(evaluation ~ algo, tss_data, FUN = function(x) c(mean = mean(x), sd = sd(x)))
write.csv(tss_summary, "./wc/Evaluation/modproj_eval_tss.csv", row.names = F)
tss_summary <- read.csv("./wc/Evaluation/modproj_eval_tss.csv")
colnames(tss_summary) <- c("algo", "tss_mean", "tss_sd")
tss_weights <- with(tss_summary, tss_mean / sum(tss_mean))
tss_summary <- cbind(tss_summary, tss_weights)
tss_summary
write.csv(tss_summary, "./wc/Evaluation/modproj_eval_tss.csv", row.names = F)
modproj_varimp <- read.csv("./wc/Evaluation/modproj_varimp.csv")
tss_weights <- read.csv("./wc/Evaluation/modproj_eval_tss.csv")
...
modproj_varimp_mean <- modproj_varimp_weighted %>%
  ...
  summarize(var.imp = sum(weighted_varimp), .groups = "drop")
modproj_varimp_mean
write.csv(modproj_varimp_mean, "./wc/Evaluation/modproj_varimp_mean.csv", row.names = F)
modproj_eval_tss <- read.csv("./wc/Evaluation/modproj_eval_tss.csv")
modproj_varimp_mean <- read.csv("./wc/Evaluation/modproj_varimp_mean.csv")
...
write.csv(ensmod_eval, "./wc/Evaluation/ensmod_eval.csv")
ensmod_varimp <- get_variables_importance(ensemble_model)
write.csv(ensmod_varimp, "./wc/Evaluation/ensmod_varimp.csv")
save.image("./wc/RData/ensemble_model.RData")
...
# Save temporary data and read
write.csv(tss_summary, "./wc/Evaluation/ensmod_eval_eval_tss.csv", row.names = F)
tss_summary <- read.csv("./wc/Evaluation/ensmod_eval_eval_tss.csv")
write.csv(roc_summary, "./wc/Evaluation/ensmod_eval_eval_roc.csv", row.names = F)
roc_summary <- read.csv("./wc/Evaluation/ensmod_eval_eval_roc.csv")
write.csv(accuracy_summary, "./wc/Evaluation/ensmod_eval_eval_accuracy.csv", row.names = F)
accuracy_summary <- read.csv("./wc/Evaluation/ensmod_eval_eval_accuracy.csv")
write.csv(pod_summary, "./wc/Evaluation/ensmod_eval_eval_pod.csv", row.names = F)
pod_summary <- read.csv("./wc/Evaluation/ensmod_eval_eval_pod.csv")
